...
# Data parameters
data_folder = 'flickr8k_output'  # folder with data files saved by create_input_files.py
    ...
    with torch.no_grad():
        ...
        for i, (imgs, caps, caplens, allcaps) in enumerate(val_loader):
            ...
            if i == 0 or i == 1:
                ...
                ref, hyp = references[0], hypotheses[0]
                for j in range(len(ref)):
                    ref_words = [rev_word_map[ind] for ind in ref[j]]
                    print("REF", ref_words)
                
                hyp_words = [rev_word_map[ind] for ind in hyp]
                print("Hyp", hyp_words)
